{
  ...
  TFile *_file0 = TFile::Open("histories_RUN2011AB_200M_etaRing.root");

  TFile * _file1=0;
  if (doAlsoTTPlots)
    _file1 = TFile::Open("histories_RUN2011AB_200M_itt.root");

  TFile *_file2=0;
  if (doAlsoXtalPlots)
    TFile *_file2 = TFile::Open("histories_RUN2011AB_200M_ixtal.root");

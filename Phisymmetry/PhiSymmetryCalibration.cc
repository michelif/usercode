...
{//sistemare
  ...
  variablesTree_barl_->Branch("nhit",&nhitBarl,"nhit/i");  
  variablesTree_barl_->Branch("ieta",etaBranch,"ieta[nhit]/I");		      
  variablesTree_barl_->Branch("iphi",phiBranch,"phi[nhit]/I");		      
  variablesTree_barl_->Branch("lc_barl",lc_barl_Branch,"lc_barl[nhit]/F");		      
  variablesTree_barl_->Branch("et_barl",et_barl_Branch,"et_barl[nhit]/F");		      
  variablesTree_barl_->Branch("unixtime",&unixtime,"unixtime/i");
  variablesTree_barl_->Branch("run",&run,"run/i");  
  variablesTree_barl_->Branch("lumi",&lumi,"lumi/i");  
  variablesTree_barl_->Branch("eventid",&eventid,"eventid/i");  

  treeFile->cd();
  variablesTree_endc_=new TTree("variablesTree_endc","variablesTree_endc");	      
  //  cout<<"TTree created"<<endl;						      
  variablesTree_endc_->Branch("nhit",&nhitEndc,"nhit/i");  
  variablesTree_endc_->Branch("ix",xBranch,"ix[nhit]/I");		      
  variablesTree_endc_->Branch("iy",yBranch,"iy[nhit]/I");		      
  variablesTree_endc_->Branch("sign",sign_endc_Branch,"sign[nhit]/i");
  variablesTree_endc_->Branch("lc_endc",lc_endc_Branch,"lc_endc[nhit]/F");		      
  variablesTree_endc_->Branch("et_endc",et_endc_Branch,"et_endc[nhit]/F");		      
...
//    cout<<"et"<<et<<"energy"<<e<<"eta"<<eta<<"phi"<<phi<<endl;  
  ...
  if(nhitBarl>0)     variablesTree_barl_->Fill();
  if(nhitEndc>0)     variablesTree_endc_->Fill();

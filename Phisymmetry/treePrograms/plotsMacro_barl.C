#define plotsMacro_barl_cxx
#include "plotsMacro_barl.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include "TFile.h"
...
void plotsMacro_barl::Loop()
{
//   In a ROOT session, you can do:
//      Root > .L plotsMacro_barl.C
//      Root > plotsMacro_barl t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   */
   ...
   TFile* outMapBarl= TFile::Open("MapsOutBarl.root","recreate");
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	 ...
	 nentries_barl_vs_etaphi->Fill(iphi[ihit],ieta[ihit]);
	 lc_barl_vs_etaphi->Fill(iphi[ihit],ieta[ihit],lc_barl[ihit]);
	 et_barl_vs_etaphi->Fill(iphi[ihit],ieta[ihit],et_barl[ihit]);
       }
       /*else {
